...
static const char *const yytname[] =
{
  ...
  "ARCHITECTURE", "OF", "SIGNAL", "BEG", "ASSIGN", "':'", "';'", "$accept",
  "program", "entity_part", "arch_part", "sig_part", "assign_part", YY_NULLPTR
};
#endif
...
{
       0,     2,     6,     1,     4,    -9,     7,    -9,     5,    -1,
       3,     9,    -9,     8,    10,    11,    -8,    12,    14,    15,
      17,    13,    16,    -3,    18,    19,    20,    21,    22,    -9,
      23,    24,    25,    -9,    -9,    -9,    26,    -9
};
...
{
      27,    18,    19,    28,     1,     4,     5,    11,     6,     8,
       9,    10,    13,    14,    17,     0,    12,    21,    22,    15,
      24,     0,    30,    31,    20,    25,     0,    26,    36,     0,
       0,    29,    32,     0,     0,    33,    34,    35,     0,    37
};

static const yytype_int8 yycheck[] =
{
       3,     9,    10,     6,     4,     3,     0,     8,     7,     5,
       3,     6,     3,     5,     3,    -1,    13,     3,     3,     9,
       3,    -1,     3,     3,    12,    12,    -1,    11,     3,    -1,
      -1,    13,    11,    -1,    -1,    13,    13,    13,    -1,    13
};
...
{
       0,     4,    15,    16,     3,     0,     7,    17,     5,     3,
       6,     8,    13,     3,     5,     9,    18,     3,     9,    10,
      12,     3,     3,    19,     3,    12,    11,     3,     6,    13,
       3,     3,    11,    13,    13,    13,     3,    13
};
...
#line 50 "myvhdl.y"
                 {
			if(strcmp(entity_name,(yyvsp[-6].id))!=0){
				char msg[256];
...
#line 61 "myvhdl.y"
                {	
			if(!is_signal_inserted((yyvsp[-3].id))){
				insert_signal((yyvsp[-3].id),(yyvsp[-1].id));
				//printf("Signals:\n  %s of type %s\n",$2,$4);
			}else{
				char msg[256];
...
#line 87 "myvhdl.y"
			...
			else if(!is_signal_inserted((yyvsp[-1].id))){
				char msg[256];
                                snprintf(msg,sizeof(msg),"UNKNOWN signal \'%s\' in line %d \n",(yyvsp[-1].id), yylineno);
                                inc_error(msg);

			}else if(!is_same_type((yyvsp[-3].id),(yyvsp[-1].id))){
				char msg[256];
